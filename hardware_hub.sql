...
CREATE TABLE IF NOT EXISTS caja(
    ...
    id_fabricante INTEGER UNSIGNED NOT NULL,
    precio DECIMAL(7, 2),
    formato ENUM('Mini-ITX', 'Micro-ATX', 'ATX', 'E-ATX') NOT NULL,
    placas_base_compatibles SET('Mini-ITX', 'Micro-ATX', 'ATX', 'E-ATX') NOT NULL,
    color VARCHAR(25),
    dimensiones JSON NOT NULL,
    psu_compatible ENUM('ATX', 'SFX', 'SFX-L', 'TFX'),
...
CREATE TABLE IF NOT EXISTS placa_base(
    ...
    id_fabricante INTEGER UNSIGNED NOT NULL,
    precio DECIMAL(7, 2),
    socket_compatible ENUM('AM4', 'AM5', 'LGA-1700', 'LGA-1851') NOT NULL,
    chipset ENUM('X570', 'B550', 'X470', 'B450', 'X870E', 'X870', 'B850', 'B840', 'X670E', 'X670', 'B650E', 'B650', 'Z790', 'B770', 'H770', 'Z690', 'B660', 'H610', 'Z890', 'B860', 'H810') NOT NULL,
    memoria_maxima SMALLINT,
    espacios_ram TINYINT,
    tipo_ram_soportada ENUM('DDR4', 'DDR5'),
    formato ENUM('Mini-ITX', 'Micro-ATX', 'ATX', 'E-ATX') NOT NULL,
